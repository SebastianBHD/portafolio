import AnimatedBg from './hero-section-animated-bg';
            ...
            <div className="bg-primary -mt-1 w-full ">
                <div className="mx-auto min-w-full max-w-screen-xl p-6 py-6 lg:py-8">
                    <div className="lg:flex items-center justify-center">
                        <div className="grid grid-cols-2 sm:gap-6 sm:grid-cols-3">
                            <div className='md:mr-20 mr-10'>
                                <h2 className="mb-6 lg:text-2xl text-sm font-semibold text-secondary uppercase dark:text-tertiary cursor-default">{t('footer.resources')}</h2>
                            ...
                            <div>
                                <h2 className="mb-6 lg:text-2xl text-sm font-semibold text-secondary uppercase dark:text-tertiary cursor-default">{t('footer.followMe')}</h2>
                                <ul className="text-tertiary lg:text-xl dark:text-tertiary font-medium">
                                    <li className="mb-4">
                    ...
                    <div className="lg:flex lg:items-center justify-center">
                        <div className="flex flex-col md:flex-row items-center gap-4 mt-4 lg:justify-center sm:mt-0">
                            <div className="flex items-center gap-2">
                                ...
                                <LanguageDropdown language={language} setLanguage={setLanguage} flagSize="w-4 h-4" textSize="text-sm" direction="up" textColor="text-white" />
                            </div>
                            <div className="flex">
