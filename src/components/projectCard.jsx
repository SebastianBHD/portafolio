        ...
        <div className="relative group">
            <div className="flex justify-center items-center">
                <div className="relative text-center rounded-md border-2 lg:transition-transform lg:duration-500 lg:ease-in-outlg:transform lg:group-hover:scale-105">
                    <img
                        className="object-cover hover:border-none rounded-md blur-sm lg:[width:300px] lg:[height:250px] xl:[width:400px] xl:[height:280px] md:[width:400px] md:[height:280px] sm:[width:400px] sm:[height:280px] [width:250px] [height:300px]"
                        src={img}
                        alt="Developer"
                    />
