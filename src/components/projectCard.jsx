    ...
    return (
        <div className="relative group">
            <div className="flex justify-center items-center ">
                <div className="relative cursor-pointer text-center rounded-md border-2 lg:transition-transform lg:duration-500 lg:ease-in-outlg:transform lg:group-hover:scale-105">
