                ...
                <div className="mx-auto min-w-full max-w-screen-xl p-6 py-6 lg:py-8">
                    <div className="lg:flex items-center justify-center">
                        <div className="grid grid-cols-2 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul className="text-tertiary lg:text-xl dark:text-tertiary font-medium">
                                    <li className="mb-4">
                                        <a href="https://www.linkedin.com/in/sebastian-britos-718040291/" rel="noopener noreferrer" target="_blank" className="hover:underline ">LinkedIn</a>
                                    </li>
                                    <li>
                    ...
                    <div className="lg:flex lg:items-center justify-center">
                        <div className="flex mt-4 lg:justify-center sm:mt-0">
                            <a href="https://www.linkedin.com/in/sebastian-britos-718040291/" rel="noopener noreferrer" target="_blank" className="text-secondary hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="https://github.com/SebastianBHD" rel="noopener noreferrer" className="text-secondary hover:text-gray-900 dark:hover:text-white ms-5">
